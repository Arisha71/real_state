					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<form action="fir-update-queries.php" method="post">
								<div class="panel-heading fa fa-edit">
									Edit customer<input type="hidden" name="customer-edit-page-id" value='<?php echo $id; ?>'>
								</div>
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="number" value='<?php echo $advance; ?>' id="amountPaid" name="advance" class="form-control input-sm">
											</div>
										</div><!-- /.col -->
										<div class="col-md-3">
											<div class="form-group">
									...
									<div class="panel-footer input text-right">
										<button class="btn btn-success fa fa-retweet" type="submit" name="update-customer"> Update & Save</button>
